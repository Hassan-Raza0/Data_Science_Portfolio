    ...
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-16 px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="inline-flex items-center justify-center space-x-2 text-cyan-400 bg-cyan-400/10 px-6 py-3 rounded-full border border-cyan-400/20">
            ...
            {contactMethods.map((method, index) => {
              ...
              return (
                <a
                  ...
                  className="card-dark rounded-2xl p-6 hover:scale-105 transition-all group text-center"
                >
                  <div className="w-14 h-14 gradient-bg rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-blue-500/30 group-hover:shadow-blue-500/50 transition-all">
                    <Icon className="text-white" size={24} />
                  </div>
                  <h3 className="font-bold text-white mb-1">{method.title}</h3>
                  <p className="text-sm text-cyan-400 font-medium mb-2">{method.value}</p>
      ...
      <section className="py-24 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div className="card-dark rounded-3xl p-8 md:p-12">
              ...
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-cyan-400/10 border border-cyan-400/20 rounded-xl flex items-start">
                  <CheckCircle className="text-cyan-400 mr-3 flex-shrink-0 mt-0.5" size={20} />
                  <div>
                    <p className="text-cyan-400 font-bold">Message sent successfully!</p>
              ...
              {submitStatus === 'error' && (
                <div className="mb-6 p-4 bg-red-400/10 border border-red-400/20 rounded-xl">
                  ...
                  <p className="text-gray-300 text-sm">Please try again or contact me directly via email.</p>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent outline-none transition-all text-white placeholder-gray-500"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent outline-none transition-all text-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent outline-none transition-all resize-none text-white placeholder-gray-500"
            ...
            <div className="space-y-8">
              <div className="card-dark rounded-2xl p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="w-12 h-12 gradient-bg rounded-xl flex items-center justify-center flex-shrink-0 mr-4 shadow-lg shadow-blue-500/30">
                      <MessageSquare className="text-white" size={20} />
                    </div>
                    <div>
                      <h4 className="font-bold text-white mb-1">Initial Response</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-white mb-1">Discovery Call</h4>
                      <p className="text-gray-300 text-sm">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-white mb-1">Proposal</h4>
                      <p className="text-gray-300 text-sm">
              ...
              <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-2xl p-8 border border-cyan-500/20">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start text-gray-300">
                    <CheckCircle className="text-cyan-400 mr-2 flex-shrink-0 mt-0.5" size={18} />
              ...
              <div className="card-dark rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <MapPin className="text-cyan-400 mr-3 flex-shrink-0 mt-1" size={20} />
                    <div>
                      <p className="font-bold text-white">Remote Work</p>
                      <p className="text-sm text-gray-300">Available for clients worldwide</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-300">Mon-Fri, 9 AM - 6 PM (EST)</p>
                    </div>
                  </div>
                </div>
              </div>
